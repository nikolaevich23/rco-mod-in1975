...
RcoFile - XML root element; generally does not need to be modified
 ...
 ---------
v1.1.2  ()
 - Update object + anim attribute names in XML (thanks phobox!) - note that the updated names may cause existing XML dumps to no longer compile (you will need to compile the dumps using older Rcomage, and redump using this version of Rcomage)
